...
export const leaveApplicationTemplate = (name, date, startDate, endDate, reason) => `
    ...
    I, ${name}, am writing this to inform you that I require leave from ${startDate} to ${endDate} due to ${reason}. I request you to kindly grant me leave for the mentioned days.
